...
export const dict = {
  ...
  "settings.context.title": "Project context",
  "settings.context.restart": "Project-only settings. Restart the OpenCode server or desktop app to apply changes. Nothing is restarted automatically.",
  "settings.context.noProject": "Open a project to change context settings.",
  "settings.context.unsupported": "These project controls require the V1 runtime. They are unavailable on this V2 server.",
  "settings.context.loading": "Loading project settings…",
  "settings.context.saving": "Saving project settings…",
  "settings.context.saved": "Saved to project configuration. Restart required; higher-priority configuration may still override compact skills.",
  "settings.context.project": "Project: {{directory}}",
  "settings.context.files": "Writes: {{config}} and {{dcp}}",
  "settings.context.compactActive": "Current runtime: compact skills enabled.",
  "settings.context.compactInactive": "Current runtime: compact skills disabled.",
  "settings.context.dcpConfigured": "DCP is registered. Switches show configuration for the next start, not live plugin health.",
  "settings.context.dcpMissing": "DCP is not registered in the effective configuration. Install and register it before using these controls.",
  "settings.context.compactSkills.title": "Compact skills",
  "settings.context.compactSkills.description": "Save a project override to send only skill names in the system prompt. Full instructions remain available through the skill tool.",
  "settings.context.dcp.title": "Dynamic context pruning (DCP)",
  "settings.context.dcp.description": "Enable the registered DCP plugin through this project's dcp.jsonc. Does not change plugin registration or compression permissions.",
  "settings.context.manualMode.title": "DCP manual mode by default",
  "settings.context.manualMode.description": "Require /dcp-compress to trigger compression. Off allows automatic model-driven compression, subject to configured permissions. Existing sessions may retain their own /dcp manual preference.",
  "settings.context.automaticStrategies.title": "Automatic strategies in manual mode",
  "settings.context.automaticStrategies.description": "Allow configured deduplication and error purging even in manual mode. Does not grant automatic compression permission.",
  "settings.context.rtkConfigured": "RTK is registered. Shell commands are rewritten through the RTK binary when it is available in PATH.",
  "settings.context.rtkMissing": "RTK is not registered in the effective configuration. Toggle it on to register the project plugin.",
  "settings.context.rtk.title": "RTK command output compression",
  "settings.context.rtk.description": "Register or remove the RTK plugin in this project's opencode.jsonc. Rewrites shell commands through RTK to shrink tool output. Needs the rtk binary in PATH and a restart.",
  "settings.context.emptyResponse": "The server returned no project settings.",
  "settings.context.loadError": "Could not load project settings: {{detail}}",
  "settings.context.saveError": "Could not confirm the save. Refresh to check the file before retrying: {{detail}}",
  "settings.context.refresh": "Refresh project settings",
